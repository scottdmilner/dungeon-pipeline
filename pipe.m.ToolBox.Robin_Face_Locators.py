...
create_locator(
    "brow_inner_l_bind_LOC", 1.9224777221679688, 157.234375, 7.205977439880371
)
cmds.parent("brow_inner_l_bind_LOC", "Locators")

create_locator(
    "brow_main_l_bind_LOC", 4.198387145996094, 157.55564880371094, 6.387408256530762
)
cmds.parent("brow_main_l_bind_LOC", "Locators")

create_locator(
    "brow_peak_l_bind_LOC", 5.9982452392578125, 157.51654052734375, 5.1865129470825195
)
cmds.parent("brow_peak_l_bind_LOC", "Locators")

create_locator(
    "brow_inner_r_bind_LOC", -1.9220428466796875, 157.23423767089844, 7.206364631652832
)
cmds.parent("brow_inner_r_bind_LOC", "Locators")

create_locator(
    "brow_main_r_bind_LOC", -4.19866943359375, 157.55499267578125, 6.387154579162598
)
cmds.parent("brow_main_r_bind_LOC", "Locators")

create_locator(
    "brow_peak_r_bind_LOC", -5.997783660888672, 157.51683044433594, 5.186444282531738
)
cmds.parent("brow_peak_r_bind_LOC", "Locators")

create_locator(
    "eyeSocket_r_bind_LOC", -3.5427756309509277, 155.02047729492188, 3.995751142501831
)
cmds.parent("eyeSocket_r_bind_LOC", "Locators")

create_locator(
    "eye_r_bind_LOC", -3.5427756309509277, 155.02047729492188, 3.995751142501831
)
cmds.parent("eye_r_bind_LOC", "Locators")

create_locator(
    "iris_r_bind_LOC", -3.6470484733581543, 155.0205078125, 6.058708667755127
)
cmds.parent("iris_r_bind_LOC", "Locators")

create_locator(
    "pupil_r_bind_LOC", -3.6470484733581543, 155.0205078125, 6.058708667755127
)
cmds.parent("pupil_r_bind_LOC", "Locators")

create_locator(
    "eyeSocket_l_bind_LOC", 3.5432958602905273, 155.02047729492188, 3.995751142501831
)
cmds.parent("eyeSocket_l_bind_LOC", "Locators")

create_locator(
    "eye_l_bind_LOC", 3.5432958602905273, 155.02047729492188, 3.995751142501831
)
...
create_locator(
    "nose_bridge_bind_LOC", -0.009210817838884111, 154.20272247612098, 6.868255446299961
)
...
create_locator(
    "jaw_end_bind_LOC", 7.62939453125e-06, 145.11997985839844, 6.618426322937012
)
