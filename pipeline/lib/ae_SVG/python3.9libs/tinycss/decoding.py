...
ENCODING_MAGIC_NUMBERS = [
    ...
    (
        ...
        re.compile(
            hex2re(
                "FE FF 00 40 00 63 00 68 00 61 00 72 00 73 00 65 00" "74 00 20 00 22"
            )
            + b"((\x00[^\x22])*?)"
            + hex2re("00 22 00 3B")
        ).match,
    ...
    (
        (Slice[1::2], "-BE"),
        re.compile(
            hex2re("00 40 00 63 00 68 00 61 00 72 00 73 00 65 00 74 00" "20 00 22")
            + b"((\x00[^\x22])*?)"
            + hex2re("00 22 00 3B")
        ).match,
    ),
    (
        ...
        re.compile(
            hex2re(
                "FF FE 40 00 63 00 68 00 61 00 72 00 73 00 65 00 74" "00 20 00 22 00"
            )
            + b"(([^\x22]\x00)*?)"
            + hex2re("22 00 3B 00")
        ).match,
    ...
    (
        (Slice[::2], "-LE"),
        re.compile(
            hex2re("40 00 63 00 68 00 61 00 72 00 73 00 65 00 74 00 20" "00 22 00")
            + b"(([^\x22]\x00)*?)"
            + hex2re("22 00 3B 00")
        ).match,
    ),
