...
def create_gui():
    ...
    cmds.button(label="Create Generic Locators", command=lambda *args: create_all_locators())
...
locator_names = [
    ...
    "nose_bottom_bind_LOC", "nose_l_outer_nostril_bind_LOC", "nose_r_outer_nostril_bind_LOC"
]
