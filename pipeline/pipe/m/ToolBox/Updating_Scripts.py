...
def update_script():
    ...
    with open(script_path, 'w') as file:
        ...
        for locator_name in locator_names:
            ...
            file.write(f'create_locator("{locator_name}", {pos[0]}, {pos[1]}, {pos[2]})\n')
...
def create_all_locators():
    ...
    locator_positions = {
        ...
        "nose_l_outer_nostril_LOC": (1.451,150.847,7.997),
        "nose_r_outer_nostril_LOC": (-1.451,150.847,7.997)
        }
...
def create_gui():
    ...
    window = cmds.window("locatorToolWindow", title="Locator Tool", widthHeight=(200, 100))

    cmds.columnLayout(adjustableColumn=True)
    cmds.text(label="Create Locators:")
    cmds.button(label="Create All Locators", command=lambda *args: create_all_locators())
...
locator_names = [
    "skull_bind_LOC", "face_upper_bind_LOC", "head_tip_bind_LOC", "brow_inner_l_bind_LOC", 
    "brow_main_l_bind_LOC", "brow_peak_l_bind_LOC", "brow_inner_r_bind_LOC", "brow_main_r_bind_LOC",
    "brow_peak_r_bind_LOC", "eyeSocket_r_bind_LOC", "eye_r_bind_LOC", "iris_r_bind_LOC", 
    "pupil_r_bind_LOC", "eyeSocket_l_bind_LOC", "eye_l_bind_LOC", "iris_l_bind_LOC", 
    "pupil_l_bind_LOC", "face_lower_bind_LOC", "face_mid_bind_LOC", "nose_bridge_bind_LOC", 
    "nose_bind_LOC", "jaw_bind_LOC", "jaw_end_bind_LOC", "nose_l_nostril_bind_LOC", "nose_r_nostril_bind_LOC", 
    "nose_bottom_bind_LOC", "nose_l_outer_nostril_LOC", "nose_r_outer_nostril_LOC"
]
