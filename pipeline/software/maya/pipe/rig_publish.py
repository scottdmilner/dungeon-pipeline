...
def rig_publish_UI():
    ...
    rigs = [(0, 'Robin'),(1, 'Rayden'), (2, 'Crossbow'), (3, 'Loot Bag'), (4, 'Door'), (5, 'test')]
    ...
    def onPress():
        ...
        conf = mc.confirmDialog(title='WARNING', message=f'Are you sure you want to publish this rig for "{fn}"? A mistake will mean you need to go fix things by hand!',
                                button=['Yes', 'No'], defaultButton='No', cancelButton='No', dismissString='No', backgroundColor=[255, 0, 0])
